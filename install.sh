...
for u in tmux-main.service cc-heartbeat.service cc-boot-notify.service cc-digest.service cc-digest.timer cc-audit.service cc-audit.timer cc-slackd.service; do
...
if [ "$services" = 1 ]; then
  ...
  systemctl --user enable --now tmux-main.service cc-heartbeat.service cc-digest.timer cc-audit.timer
