...
Smallest context has one hard edge: a seat still past the rotate line (`CC_CONTEXT_ROTATE_TOKENS`, 200k) is
rotated by the box on the next reconcile tick, nag acted on or not (`cc-handoff`, ROTATION).
