...
PYTHONDONTWRITEBYTECODE=1 python3 -m py_compile "${py[@]}" mail/*.py tests/slack_sim.py tests/slack_selfcheck.py tests/member_v2.py tests/member_broker.py tests/member_import.py "$@"
